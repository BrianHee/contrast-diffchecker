    ...
    return (
        ...
        >
            <div className='about-container'>
                ...
                <h3><b>contrast</b> is a difference checking tool that enables programmers
                ...
                <h3><b>3.</b> Visualize the differences in the texts with <b>contrast</b>'s difference viewing interface.</h3>
                <h3>After having submitted two samples of text,
                     the user will be prompted with a difference viewer:
                </h3>
                <h4>
